...
deps_tools/env_embedded.o := \
  ...
  tools/../common/env_embedded.c \
    ...
    $(wildcard include/config/nand/u/boot.h) \
...
tools/env_embedded.o: $(deps_tools/env_embedded.o)
